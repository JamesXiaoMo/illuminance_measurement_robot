...
bool power_measurement__msg__ina228_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("power_measurement.msg._ina228_sensor.Ina228Sensor", full_classname_dest, 49) == 0);
  }
  power_measurement__msg__Ina228Sensor * ros_message = _ros_message;
  {  // voltage
...
{
  /* NOTE(esteve): Call constructor of Ina228Sensor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("power_measurement.msg._ina228_sensor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Ina228Sensor");
